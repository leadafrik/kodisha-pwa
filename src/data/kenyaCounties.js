...
exports.validateAdministrativeHierarchy = exports.searchAdministrativeArea = exports.getAllConstituencies = exports.getWardByCode = exports.getCountyByCode = exports.getWardsByConstituency = exports.getConstituenciesByCounty = exports.getCountiesForDropdown = exports.kenyaCounties = void 0;
exports.kenyaCounties = [
    {
        code: 1,
        name: 'MOMBASA',
        constituencies: [
...
const getCountiesForDropdown = () => {
    return exports.kenyaCounties.map(county => ({
        value: county.name.toLowerCase(),
        label: county.name
    }));
};
exports.getCountiesForDropdown = getCountiesForDropdown;
// Helper function to get constituencies by county
const getConstituenciesByCounty = (countyName) => {
    const county = exports.kenyaCounties.find(c => c.name.toLowerCase() === countyName.toLowerCase());
    return county ? county.constituencies.map(constituency => ({
        value: constituency.name,
        label: constituency.name
    })) : [];
};
exports.getConstituenciesByCounty = getConstituenciesByCounty;
// Helper function to get wards by constituency
const getWardsByConstituency = (countyName, constituencyName) => {
    const county = exports.kenyaCounties.find(c => c.name.toLowerCase() === countyName.toLowerCase());
    if (!county)
        return [];
...
exports.getWardsByConstituency = getWardsByConstituency;
// Additional utility functions
const getCountyByCode = (code) => {
    return exports.kenyaCounties.find(county => county.code === code);
};
exports.getCountyByCode = getCountyByCode;
const getWardByCode = (wardCode) => {
    for (const county of exports.kenyaCounties) {
...
const getAllConstituencies = () => {
    return exports.kenyaCounties.flatMap(county => county.constituencies.map(constituency => ({
        value: constituency.name,
        label: constituency.name,
        county: county.name
    })));
...
const searchAdministrativeArea = (query) => {
    const results = {
        counties: [],
        constituencies: [],
        wards: []
    };
    exports.kenyaCounties.forEach(county => {
...
exports.searchAdministrativeArea = searchAdministrativeArea;
const validateAdministrativeHierarchy = (countyName, constituencyName, wardName) => {
    const county = exports.kenyaCounties.find(c => c.name.toLowerCase() === countyName.toLowerCase());
    if (!county)
        return false;
    const constituency = county.constituencies.find(c => c.name === constituencyName);
...
exports.validateAdministrativeHierarchy = validateAdministrativeHierarchy;
