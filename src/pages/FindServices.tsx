...
const FindServices: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      <div className="rounded-2xl bg-emerald-700 px-6 py-8 text-white shadow-sm md:px-10 md:py-10">
      ...
      <div className="rounded-2xl bg-emerald-700 p-8 text-center text-white shadow-sm">
        <h2 className="text-2xl font-bold mb-3">
          Have Equipment or Services to Offer?
        </h2>
        <p className="mx-auto mb-5 max-w-2xl text-sm text-emerald-50 md:text-base">
        ...
        <Link
          to="/create-listing"
          className="inline-flex items-center rounded-lg bg-white px-7 py-2.5 text-sm font-semibold text-emerald-700 transition-colors hover:bg-emerald-50"
        >
          List Your Service/Equipment
        </Link>
      </div>
