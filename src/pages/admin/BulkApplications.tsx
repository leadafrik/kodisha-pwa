  ...
  return (
    <main className="ui-page-shell p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="ui-hero-panel p-6">
          <p className="ui-section-kicker">
            Admin
          </p>
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-stone-900">Bulk applications</h1>
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            <div className="ui-card-soft px-4 py-3">
              <p className="text-xs uppercase tracking-widest text-stone-500">Pending</p>
              <p className="text-2xl font-semibold text-stone-900">{summary.pending}</p>
            </div>
            <div className="ui-card-soft px-4 py-3">
              <p className="text-xs uppercase tracking-widest text-stone-500">Approved</p>
              <p className="text-2xl font-semibold text-stone-900">{summary.approved}</p>
            </div>
            <div className="ui-card-soft px-4 py-3">
              <p className="text-xs uppercase tracking-widest text-stone-500">Rejected</p>
              <p className="text-2xl font-semibold text-stone-900">{summary.rejected}</p>
            </div>
          </div>
        </header>
              ...
              {visibleItems.map((item) => (
                <article key={item._id} className="p-5">
                  ...
                  <div className="mt-4 grid gap-3 md:grid-cols-3">
                    <div className="ui-card-soft px-3 py-2 text-xs">
                      <p className="font-semibold uppercase tracking-widest text-stone-500">
                        Products
                      </p>
                  ...
                  {item.notes && (
                    <p className="mt-3 text-sm text-stone-600">
                      <span className="font-semibold text-stone-800">Application notes:</span>{" "}
                      {item.notes}
                    </p>
                  )}
                  {item.reviewNotes && (
                    <p className="mt-1 text-sm text-stone-600">
                      <span className="font-semibold text-stone-800">Review notes:</span>{" "}
                      {item.reviewNotes}
                    </p>
                  )}
